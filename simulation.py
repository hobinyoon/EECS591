...
if __name__ == '__main__':
  ...
  parser.add_argument('--algorithm', choices=['volley', 'greedy', 'central_greedy',  'distributed'], help='the algorithm used for replication')
  ...
  if algorithm == 'volley':
    ...
    print '************************* Running central_greedy *************************'
    central_greedy = SimpleCentralizedGreedy()
    central_greedy.last_timestamp = before_start_time
    central_greedy.execute()
    ...
    print '************************* Average latency ****************************'
    print 'BEFORE_central_greedy: ' + str(average_latency_before_greedy) + ', start time: ' + str(before_start_time) + ', end time: ' + str(before_end_time)
    print 'AFTER_central_greedy: ' + str(average_latency_after_greedy) + ', start time: ' + str(after_start_time) + ', end time: ' + str(after_end_time)
    print '*************** Inter Datacenter Communication Cost ******************'
    print 'Simple Centralized Greedy: ' + str(inter_datacenter_traffic)
  elif algorithm == 'distributed':
    # FIXME: use dataset/synthetic/03_real_time_algorithm/access_log.txt here?
    pass
