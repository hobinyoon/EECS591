...
from simple_centralized_greedy import SimpleCentralizedGreedy
...
if __name__ == '__main__':
  ...
  parser.add_argument('--algorithm', choices=['volley', 'greedy', 'simple_centralized_greedy',  'distributed'], help='the algorithm used for replication')
  ...
  if algorithm == 'volley':
  ...
  elif algorithm == 'simple_centralized_greedy':
    print '************************* Set up simulation environment *************************'
    update_ip_lat_long_map('dataset/synthetic/01_random_replication/ip_lat_long_map.txt')
    # update_ip_lat_long_map('dataset/synthetic/02_replication_effects/ip_lat_long_map.txt')
    # update_ip_lat_long_map('dataset/synthetic/03_real_time_algorithm/ip_lat_long_map.txt')
    ...
    print '************************* Average latency ****************************'
    print 'BEFORE_SIMPLE_CENTRALIZED_GREEDY: ' + str(average_latency_before_greedy) + ', start time: ' + str(before_start_time) + ', end time: ' + str(before_end_time)
    print 'AFTER_SIMPLE_CENTRALIZED_GREEDY: ' + str(average_latency_after_greedy) + ', start time: ' + str(after_start_time) + ', end time: ' + str(after_end_time)
    print '*************** Inter Datacenter Communication Cost ******************'
