...
if __name__ == '__main__':
  ...
  start_time, end_time, request_map = replay_log.simulate_requests('dataset/sample_log_ready', args['disable_concurrency'], None)
  ...
  start_time, end_time, request_map = replay_log.simulate_requests('dataset/sample_log_ready', False, request_map)
